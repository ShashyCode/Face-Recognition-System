...
from FaceDetection import data
...
class PageThree(tk.Frame):
    ...
    def capimg(self):
        ...
        messagebox.showinfo("INSTRUCTIONS", "We will capture 30 pictures of your Face.")
        x = data(self.controller.active_name)
    ...
    def trainmodel(self):
        if self.controller.num_of_images < 30:
            ...
            return
        train(self.controller.active_name)
...
class PageFour(tk.Frame):
    ...
    def openwebcam(self):
        main(self.controller.active_name)
